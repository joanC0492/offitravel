...
class WMSC_Compatibilities {
	...
	public static function wp_enqueue_scripts() {
		...
		if ( strpos( $theme, 'huntor' ) !== false ) {
			...
			remove_action('woocommerce_checkout_before_customer_details', 'huntor_checkout_before_customer_details_container', 1);
	...
	/**
	 * Huntor theme buttons.
	 *
	 * @param string $btn The buttons' class.
	 * @return string.
	 */
	public static function huntor_buttons( $btn ) {
		return $btn . ' button-default button-outline-dark';
	}
	 ...
	 * @return string.
	 */
	public static function woocommerce_registration_error_email_exists( $message ) {
