...
;// ./resources/js/frontend/blocks/inner-blocks/checkout-order-summary-gift-card-form/index.js
/**
 * External dependencies
 */
...
const registerInnerBlock = () => {
  ...
  (0,external_wc_blocksCheckout_namespaceObject.registerCheckoutBlock)({
    metadata: checkout_order_summary_gift_card_form_block_namespaceObject,
    component: props => /*#__PURE__*/(0,jsx_runtime.jsx)(block, {
      ...props
    })
  });
};
...
;// ./resources/js/frontend/blocks/inner-blocks/checkout-order-summary-gift-card-totals/index.js
/**
 * External dependencies
 */
...
const checkout_order_summary_gift_card_totals_registerInnerBlock = () => {
  // Register Block to render in FrontEnd.
  (0,external_wc_blocksCheckout_namespaceObject.registerCheckoutBlock)({
    metadata: inner_blocks_checkout_order_summary_gift_card_totals_block_namespaceObject,
    component: props => /*#__PURE__*/(0,jsx_runtime.jsx)(checkout_order_summary_gift_card_totals_block, {
      ...props
    })
  });
};
...
;// ./resources/js/frontend/blocks/inner-blocks/cart-order-summary-gift-card-form/index.js
/**
 * External dependencies
 */
...
const cart_order_summary_gift_card_form_registerInnerBlock = () => {
  // Register Block to render in FrontEnd.
  (0,external_wc_blocksCheckout_namespaceObject.registerCheckoutBlock)({
    metadata: inner_blocks_cart_order_summary_gift_card_form_block_namespaceObject,
    component: props => /*#__PURE__*/(0,jsx_runtime.jsx)(cart_order_summary_gift_card_form_block, {
      ...props
    })
  });
};
...
;// ./resources/js/frontend/blocks/inner-blocks/cart-order-summary-gift-card-totals/index.js
/**
 * External dependencies
 */
...
const cart_order_summary_gift_card_totals_registerInnerBlock = () => {
  // Register Block to render in FrontEnd.
  (0,external_wc_blocksCheckout_namespaceObject.registerCheckoutBlock)({
    metadata: inner_blocks_cart_order_summary_gift_card_totals_block_namespaceObject,
    component: props => /*#__PURE__*/(0,jsx_runtime.jsx)(cart_order_summary_gift_card_totals_block, {
      ...props
    })
  });
};
