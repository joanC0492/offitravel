<?php
/**
 * Huespedes: modo habitaciones (Offitravel) o plantilla Tripgo por defecto.
 *
...
if ( function_exists( 'offitravel_ovabrw_room_mode_enabled' ) && offitravel_ovabrw_room_mode_enabled( $product_id ) ) {
	wc_get_template(
		'rental/loop/fields/guests-rooms.php',
		array(
			'args' => $args,
		)
	);
					...
					tripgo_text_input(
						array(
							...
							'attrs'    => array(
								'min'        => $min_adults,
								'max'        => $max_adults,
								'data-label' => esc_html__( 'Adultos', 'ova-brw' ),
			...
			<?php if ( $show_children ) : ?>
				<div class="guests-buttons">
					<div class="description">
						...
						<?php if ( 'yes' === $show_price_children ) : ?>
						...
						tripgo_text_input(
							array(
								...
								'attrs'    => array(
									'min'        => $min_children,
									'max'        => $max_children,
									'data-label' => esc_html__( 'Ninos', 'ova-brw' ),
						...
						tripgo_text_input(
							array(
								...
								'attrs'    => array(
									'min'        => $min_babies,
									'max'        => $max_babies,
									'data-label' => esc_html__( 'Bebes', 'ova-brw' ),
